...
class DesignTokenServiceProvider extends ServiceProvider
{
     ...
     * Markup lives in templates/admin/design-tokens-page.blade.php.
     */
    public function addTokensPageScript(): void
    {
        ...
        $html = blade('admin.design-tokens-page', [
            'ajaxUrl' => admin_url('admin-ajax.php'),
            'uploadNonce' => wp_create_nonce(self::nonceUpload()),
            'restoreNonce' => wp_create_nonce(self::nonceRestore()),
            'uploadAction' => self::ajaxActionUploadTokens(),
            'restoreAction' => self::ajaxActionRestoreBackup(),
