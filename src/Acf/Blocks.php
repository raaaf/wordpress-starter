...
class Blocks
{
    ...
    public static function registerCategories(array $categories, \WP_Block_Editor_Context $context): array
    {
        ...
        $themeCategories = [
            [
                'slug' => 'theme-layout',
                'title' => '📐 ' . __('Layout', 'foreign-theme-a-gmbh'),
                'icon' => 'columns',
            ],
            [
                'slug' => 'theme-content',
                'title' => '📝 ' . __('Inhalte', 'foreign-theme-a-gmbh'),
                'icon' => 'editor-alignleft',
            ],
            [
                'slug' => 'theme-media',
                'title' => '🖼️ ' . __('Medien', 'foreign-theme-a-gmbh'),
                'icon' => 'format-gallery',
            ],
            [
                'slug' => 'theme-interactive',
                'title' => '✨ ' . __('Interaktiv', 'foreign-theme-a-gmbh'),
                'icon' => 'star-filled',
            ],
            [
                'slug' => 'theme',
                'title' => '🎨 ' . __('Theme Blocks', 'foreign-theme-a-gmbh'),
                'icon' => 'layout',
            ],
        ];
...
<div class="{{ $classes }}" @if($anchor) id="{{ $anchor }}" @endif>
    @if($is_preview)
        <p>{{ __('Block preview', 'foreign-theme-a-gmbh') }}</p>
    @else
        {{-- Block content here --}}
    @endif
</div>
