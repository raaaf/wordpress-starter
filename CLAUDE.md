...
When cloning this theme for a new project, run the setup wizard:
...
1. Configure theme name, author, and other metadata
...
- `bin/` - CLI scripts
  - `setup.php` - Theme setup wizard for new projects
