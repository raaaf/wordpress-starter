...
<section class="{{ $classes }} flex flex-col gap-8 px-6 two-columns-images lg:gap-24 lg:px-8 text-marine"
         @if($anchor) id="{{ $anchor }}" @endif>
    {{-- First Row: Content Left, Image Right --}}
    <div class="relative grid items-stretch mx-auto overflow-hidden border rounded-lg border-{{ $bgColor }} max-w-6xl lg:grid-cols-2">
        <div class="order-last h-full lg:overflow-hidden lg:order-first">
            <div class="relative h-full transition duration-200 bg-{{ $bgColor }}/10">
