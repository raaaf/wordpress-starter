...
add_action('wp_enqueue_scripts', function () {
	...
	wp_enqueue_script( 'app', theme_get_mix_compiled_asset_url( '/dist/app.js' ), array( 'jquery' ), $theme->get( 'Version' ) );
});
...
/**
 * Get data from the theme.json file.
 *
...
function theme_get_data( $key = null ) {
	$config = json_decode( file_get_contents( get_stylesheet_directory() . '/theme.json' ), true );
