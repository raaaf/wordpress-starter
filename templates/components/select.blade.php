...
@php
    ...
    $baseClasses = 'w-full border bg-surface-secondary text-content appearance-none cursor-pointer transition-[color,background,border-color,box-shadow] duration-200 focus:outline-none';
