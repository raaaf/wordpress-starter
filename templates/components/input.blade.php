...
@php
    ...
    $baseClasses = 'input w-full border bg-surface text-content placeholder:text-content-placeholder transition-[color,background,border-color,box-shadow] duration-200 focus:outline-none';
