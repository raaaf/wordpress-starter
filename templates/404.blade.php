    ...
    <x-section background="secondary" padding="xl">
        <div class="text-center max-w-2xl mx-auto">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <x-button :url="home_url('/')" variant="primary" size="lg" :title="__('Zur Startseite', 'wp-starter')">
                ...
                <x-button variant="secondary" size="lg" :title="__('Zurück', 'wp-starter')" onclick="history.back()">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
