        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div class="lg:col-span-1">
                ...
                @if($showCompany && $company)
                    <h3 class="text-lg font-semibold text-content mb-4">{{ $company }}</h3>
                @endif
                @if($footerText)
            ...
            @if($showContact && ($address || $phone || $email))
                <div>
                    <h3 class="text-lg font-semibold text-content mb-4">{{ $contactTitle }}</h3>
            ...
            @if($showSocial && !empty($socialLinks))
                <div>
                    <h3 class="text-lg font-semibold text-content mb-4">{{ $socialTitle }}</h3>
